...
def open_help_window():
    ...
    github_button = ttk.Button(frame, text="Open GitHub",
...
def open_feedback_window():
    ...
    frame = ttk.Frame(window, padding="10")
    frame.pack(fill='both', expand=True)
    sample_text = ttk.Label(frame, text="Have feedback to share?\nOpen an issue at github here: "
                                        "github.com/Misha1tigr/NeboKrug", justify="center", font="bold")
    sample_text.grid(column=0, row=0, padx=5, pady=5)
...
def open_about_window():
    ...
    content = [
        ...
        ("About:", True),
        (
        "The Weather App is a versatile and user-friendly application designed to provide comprehensive weather "
        "information, historical data, and AI-driven outfit recommendations. Built using Python and leveraging the "
        "Open-Meteo API, the app offers a wide range of features to keep users informed and prepared for any weather "
        "conditions.",
        False),
        ("Features:", True),
        (
        "- Current Weather & Forecast: Get up-to-date weather information and a 14-day forecast for your selected "
        "locations.",
        False),
        (
        "- Historical Weather Data: Access historical weather data, allowing you to compare today's weather with past "
        "conditions.",
        False),
        ...
        (
        "This app was developed as part of a coursework project, and I would like to extend my gratitude to the "
        "following resources and libraries that made this possible:",
        False),
    ...
    for text, is_bold in content:
        if text == "separator":
            ...
            if is_bold:
                ...
                label = ttk.Label(frame, text=text, wraplength=400)
